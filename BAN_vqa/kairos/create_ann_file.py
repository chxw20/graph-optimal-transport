...
def gen_xml(task, fnames):
    ...
    for fname in fnames:
        ...
        for img_id in imgid2ents:
            ...
            open(f"data/{task}/{img_id}.xml", 'w').write(xmlstr)


if __name__ == "__main__":

    args = parse_args()
    gen_xml(args.task, os.listdir(f"data/{task}/json"))
